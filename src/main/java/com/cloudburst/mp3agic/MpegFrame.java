...
public class MpegFrame {
	...
	public MpegFrame(byte frameData1, byte frameData2, byte frameData3, byte frameData4, int fileOffset) throws InvalidDataException {
	...
	public String toString() {
		return "MpegFrame{" +
				...
				", bytes=" + getLengthInBytes() +
				", millis=" + getLengthInMilliseconds() +
				", version='" + version + '\'' +
				", layer=" + layer +
