...
public class BaseExceptionTest {
	...
	public void generatesCorrectDetailedMessageForSingleException() {
		...
		assertEquals("[BaseException: ONE]", e.getDetailedMessage());
	}
	...
	public void generatesCorrectDetailedMessageForChainedBaseExceptions() {
		...
		assertEquals("[InvalidDataException: FIVE] caused by [NoSuchTagException: FOUR] caused by [NotSupportedException: THREE] caused by [UnsupportedTagException: TWO] caused by [BaseException: ONE]", e5.getDetailedMessage());
	}
	...
	public void generatesCorrectDetailedMessageForChainedExceptionsWithOtherExceptionInMix() {
		...
		BaseException e5 = new InvalidDataException("FIVE", e4);
		assertEquals("FIVE", e5.getMessage());
		assertEquals("[InvalidDataException: FIVE] caused by [NoSuchTagException: FOUR] caused by [java.lang.Exception: THREE] caused by [UnsupportedTagException: TWO] caused by [BaseException: ONE]", e5.getDetailedMessage());
	}
}
