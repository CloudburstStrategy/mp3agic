...
public class Mp3FileTest {
	...
	@Test
	public void checkFramesNoTags() throws IOException, UnsupportedTagException, InvalidDataException {
		Mp3File file = new Mp3File(MP3_WITH_NO_TAGS);
		int idx = 0;
		for (MpegFrame mpegFrame : file.getFrames()) {
			System.out.println("Frame " + idx++ + " --> " +  mpegFrame);
		}
